...
WHO_PIDS=(TEST_FRAME)	# all pids greater than, use the who header for routing
PING=0x1	# to check other end
PING_BACK=0x2	# expected response to a PING
SPS=0x3	# used for initializing SPS frame acks and setting id
SPS_ACK=0x4	# confirm sps; must contain sender - who.from
...
pids = {
	...
	SPS_ACK:"SPS_ACK",	# confirm sps; must contain sender - who.from
